    ...
    <div class="col-lg-8 m-auto d-block">
      ...
      <form action="checked.php" method="post">
        ...
        <?php
          ...
          $q = "SELECT * FROM questions where qid=$i and cid=3";
        ...
        <div class="card">
            ...
            <?php
              $q = "SELECT * FROM answers where qid=$i and cid=3";
              $query = mysqli_query($con, $q);
          ...
          <input type="submit" name="submit3" value="Submit" class="btn btn-outline-success m-auto d-block">
        </div>
      </form>
    </div>
    <br><br><br><br>
