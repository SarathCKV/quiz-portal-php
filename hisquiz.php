    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
          <li><a href="index.php">General Knowledge</a></li>
          <li class="active"><a href="hisquiz.php">History</a></li>
    ...
    <div class="col-lg-8 m-auto d-block">
      ...
      <form action="checked.php" method="post">
        ...
        <?php
          ...
          $q = "SELECT * FROM questions where qid=$i and cid=2";
        ...
        <div class="card">
            ...
            <?php
              $q = "SELECT * FROM answers where qid=$i and cid=2";
              $query = mysqli_query($con, $q);
          ...
          <input type="submit" name="submit2" value="Submit" class="btn btn-outline-success m-auto d-block">
        </div>
      </form>
    </div>
    <br><br><br><br>
